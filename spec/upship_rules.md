...
| **Barracks** | Zone on your Player Board where Officer and Engineer tokens are stored. (§3.3) |
...
| **Officer** | Crew token required to launch a ship (1 per Age number). Spent from Barracks to shared supply on launch. (§3.3) |
...
- **Officers:** Required to launch a ship. When you launch a ship, you spend Officers equal to the current Age number (1 in Age I, 2 in Age II, 3 in Age III) from your Barracks back to the shared supply. Officers are only returned to your Barracks when:
...
- **Officer Income Track:** Tracks free Officers gained per round (starts at 0—requires investment at Flight School)
...
| **Brussels** | +1 Officer | Aviation pioneers |
...
| **Scapa Flow** | +1 Officer | Naval aviation |
...
- **Cost:** £2 per Officer, £4 per Engineer
- **Result:** Gain Officer or Engineer tokens from the shared supply to your Barracks
- **Market Purge:** You may also discard the leftmost card from the Market Row (removing unwanted cards from circulation)
- **Note:** Officers are cheaper because they are consumed when launching ships; Engineers persist and generate ongoing Research

**6. The Flight School (Coin)**
- **Action:** Expand your officer training program
- **Cost:** £5 per level
- **Effect:** Increase your Officer Income track by 1 step
- **Strategic Note:** Investing in Officer Income provides a steady stream of free Officers each round, reducing reliance on the Academy. Since Officer Income starts at 0, early investment here is crucial for sustained operations.
...
- **Policy Benefit:** When one of your ships **crashes** (destroyed by fire or catastrophic hazard), you may discard one policy card to recover the airship token to your Launch Hangar instead of losing it. You still lose the Officers and any gas spent, but you keep the ship for another attempt.
...
- **Officer:** Gain Officer tokens to your Barracks
...
3. **Collect Crew Income:** Each player gains Officers equal to their Officer Income Track, and Engineers equal to their Engineer Income Track
...
| Card | Effect |
|------|--------|
| **Engine Fire** | Spend 1 Engineer to control. Success: Ship is **Damaged** (→ Repair Hangar). Failure: Ship **crashes**, Officers lost. |
| **Gas Cell Rupture** | Spend 2 Engineers to control. Success: Ship is **Damaged** (→ Repair Hangar). Failure: Ship **crashes**, Officers lost. |
| **Catastrophic Explosion** | No save possible. Ship **crashes**, Officers lost. If this occurs during a Luxury Launch in Age III: triggers the **Hindenburg Disaster** game end. |
...
- The Officers survive but return to the shared supply
...
- **Officer:** Gain an Officer token to your Barracks
...
- Example: *Test Pilot* — Propeller: +2 Reliability for this launch. Reveal: 1 Officer
...
4. **Officer Recovery:** All Officers spent on ships return to player Barracks.
...
6. Set up the **Officer and Engineer Token** shared supplies
...
4. **£15 Cash**
5. **1 Officer Token** from shared supply (placed in Barracks)
...
11. **Set Officer Income Track** to 0 (requires investment at Flight School to increase)
...
In all failure cases (Aborted, Damaged, Crash), the Officers and any gas spent on the launch are lost.
...
See appendix.md for the following appendixes:
