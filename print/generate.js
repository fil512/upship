...
async function loadCardData() {
  ...
  const hazardCards = [
    ...
    // Minor Hazards (8) - Simplified: Total Difficulty = Hazard Difficulty - Ship Reliability
    { id: 'minor_hazard_0', name: 'Light Turbulence', category: 'minor', difficulty: 2, flak: 0 },
    { id: 'minor_hazard_1', name: 'Minor Engine Trouble', category: 'minor', difficulty: 1, flak: 1 },
    { id: 'minor_hazard_2', name: 'Crosswind', category: 'minor', difficulty: 3, flak: 0 },
    { id: 'minor_hazard_3', name: 'Gas Leak', category: 'minor', difficulty: 2, flak: 1 },
    { id: 'minor_hazard_4', name: 'Low Visibility', category: 'minor', difficulty: 2, flak: 1 },
    { id: 'minor_hazard_5', name: 'Fuel Concern', category: 'minor', difficulty: 2, flak: 0 },
    { id: 'minor_hazard_6', name: 'Headwind', category: 'minor', difficulty: 3, flak: 1 },
    { id: 'minor_hazard_7', name: 'Structural Stress', category: 'minor', difficulty: 2, flak: 2 },
    // Major Hazards (8) - Simplified: Total Difficulty = Hazard Difficulty - Ship Reliability
    { id: 'major_hazard_0', name: 'Strong Headwind', category: 'major', difficulty: 4, flak: 2 },
    { id: 'major_hazard_1', name: 'Icing Conditions', category: 'major', difficulty: 3, flak: 2 },
    { id: 'major_hazard_2', name: 'Engine Failure', category: 'major', difficulty: 3, flak: 3 },
    { id: 'major_hazard_3', name: 'Storm System', category: 'major', difficulty: 4, flak: 3 },
    { id: 'major_hazard_4', name: 'Structural Damage', category: 'major', difficulty: 3, flak: 4 },
    { id: 'major_hazard_5', name: 'Navigation Error', category: 'major', difficulty: 3, flak: 3 },
    { id: 'major_hazard_6', name: 'Squall Line', category: 'major', difficulty: 4, flak: 3 },
    { id: 'major_hazard_7', name: 'Severe Icing', category: 'major', difficulty: 2, flak: 2 },
    // Fire Hazards (6) - Hydrogen ships only
    ...
    { id: 'static_discharge_0', name: 'Static Discharge', category: 'fire', difficulty: 2, flak: 4 },
