...
declare module '$env/static/private' {
	...
	export const JLINE_TERMINAL: string;
	export const HOMEBREW_REPOSITORY: string;
	export const SONAR_HOST_URL: string;
	...
	export const SONAR_TOKEN: string;
	...
	export const AWS_JAVA_V1_DISABLE_DEPRECATION_ANNOUNCEMENT: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		AWS_JAVA_V1_DISABLE_DEPRECATION_ANNOUNCEMENT: string;
