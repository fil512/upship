...
export const TECH_CARD_BAG: Record<number, TechCard[]> = {
  ...
  2: [ // Age II Technologies (22 tiles) - Cost range: 6-8 Research
    // Note: Helium Handling is NOT in the bag - it's the Reserve Tech Card (always available)
    // Propulsion (4 tiles)
    { id: 'maybach_engine', name: 'Maybach Engine Design', type: 'drive', cost: 7, vp: 0, income: 2 },
    { id: 'diesel_powerplant', name: 'Diesel Powerplant', type: 'drive', cost: 7, vp: 1, income: 1 },
    { id: 'swiveling_propeller', name: 'Swiveling Propeller', type: 'drive', cost: 8, vp: 1, income: 2 },
    { id: 'contra_rotating', name: 'Contra-Rotating Props', type: 'drive', cost: 8, vp: 0, income: 2 },
    // Frame (5 tiles)
    { id: 'duralumin_framework', name: 'Duralumin Framework', type: 'structure', cost: 7, vp: 0, income: 2 },
    { id: 'steel_framework', name: 'Steel Framework', type: 'structure', cost: 6, vp: 2, income: 1 },
    { id: 'internal_keel', name: 'Internal Keel', type: 'structure', cost: 7, vp: 1, income: 1 },
    ...
    // Fabric (4 tiles)
    { id: 'goldbeater_skin', name: "Goldbeater's Skin", type: 'fabric', cost: 8, vp: 2, income: 2 },
    { id: 'fireproof_coating', name: 'Fireproof Coating', type: 'fabric', cost: 7, vp: 2, income: 1 },
    { id: 'aluminum_doping', name: 'Aluminum Doping', type: 'fabric', cost: 7, vp: 1, income: 1 },
    { id: 'grounding_systems', name: 'Grounding Systems', type: 'fabric', cost: 7, vp: 1, income: 1 },
    // Gas Systems (3 tiles) - Helium Handling is Reserve Tech Card, not in bag
    { id: 'multiple_gas_cells', name: 'Multiple Gas Cells', type: 'gas', cost: 7, vp: 0, income: 1 },
    { id: 'blaugas_system', name: 'Blaugas Fuel System', type: 'gas', cost: 7, vp: 2, income: 2, stats: { range: 1 } },
    { id: 'automatic_valves', name: 'Automatic Valves', type: 'gas', cost: 8, vp: 1, income: 2 },
    // Payload (6 tiles)
    { id: 'passenger_gondola', name: 'Passenger Gondola', type: 'component', cost: 7, vp: 0, income: 1 },
    { id: 'bomb_bay', name: 'Bomb Bay Design', type: 'component', cost: 8, vp: 3, income: 2 },
    { id: 'trapeze_system', name: 'Trapeze System', type: 'component', cost: 8, vp: 2, income: 2 },
    { id: 'radio_equipment', name: 'Radio Equipment', type: 'component', cost: 7, vp: 1, income: 1 },
    { id: 'armored_gondola', name: 'Armored Gondola', type: 'component', cost: 7, vp: 1, income: 1 },
    { id: 'reinforced_hull', name: 'Reinforced Hull', type: 'component', cost: 8, vp: 2, income: 2 }
  ],
  3: [ // Age III Technologies (19 tiles) - Cost range: 9-11 Research
    // Propulsion (4 tiles)
    { id: 'streamlined_nacelle', name: 'Streamlined Nacelle', type: 'drive', cost: 9, vp: 0, income: 2 },
    { id: 'supercharged_engine', name: 'Supercharged Engine', type: 'drive', cost: 10, vp: 1, income: 3 },
    { id: 'diesel_electric', name: 'Diesel-Electric Drive', type: 'drive', cost: 10, vp: 1, income: 2 },
    { id: 'variable_pitch', name: 'Variable-Pitch Propeller', type: 'drive', cost: 9, vp: 0, income: 2 },
    // Frame (3 tiles)
    { id: 'geodetic_structure', name: 'Geodetic Structure', type: 'structure', cost: 9, vp: 0, income: 2 },
    { id: 'modular_construction', name: 'Modular Construction', type: 'structure', cost: 10, vp: 3, income: 2 },
    { id: 'dynamic_lift', name: 'Dynamic Lift Surfaces', type: 'structure', cost: 10, vp: 2, income: 2, stats: { lift: 4 } },
    // Fabric (2 tiles)
    { id: 'gelatinized_latex', name: 'Gelatinized Latex', type: 'fabric', cost: 9, vp: 0, income: 2 },
    { id: 'composite_covering', name: 'Composite Covering', type: 'fabric', cost: 10, vp: 1, income: 2 },
    // Gas Systems (5 tiles)
    { id: 'pressure_altitude', name: 'Pressure Altitude System', type: 'gas', cost: 10, vp: 1, income: 3 },
    { id: 'triple_gas_cell', name: 'Triple Gas Cell', type: 'gas', cost: 9, vp: 0, income: 2 },
    { id: 'emergency_venting', name: 'Emergency Venting', type: 'gas', cost: 9, vp: 2, income: 2 },
    { id: 'gas_recovery', name: 'Gas Recovery', type: 'gas', cost: 10, vp: 2, income: 2 },
    { id: 'water_recovery', name: 'Water Recovery System', type: 'gas', cost: 10, vp: 1, income: 2 },
    // Payload (5 tiles)
    { id: 'luxury_accommodation', name: 'Luxury Accommodation', type: 'component', cost: 9, vp: 0, income: 2 },
    { id: 'dining_saloon', name: 'Dining Saloon', type: 'component', cost: 10, vp: 0, income: 3 },
    { id: 'promenade_deck', name: 'Promenade Deck', type: 'component', cost: 11, vp: 2, income: 3 },
    { id: 'sleeping_quarters', name: 'Sleeping Quarters', type: 'component', cost: 9, vp: 1, income: 2 },
    { id: 'smoking_room', name: 'Smoking Room', type: 'component', cost: 10, vp: 3, income: 2 }
  ]
};
