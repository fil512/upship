...
export const TECH_CARD_BAG: Record<number, TechCard[]> = {
  1: [ // Age I Technologies (12 tiles) - Cost range: 1-2 Research (per Appendix C)
    // Propulsion (3 tiles)
  ...
  2: [ // Age II Technologies (22 tiles) - Cost range: 2-4 Research (per Appendix C)
  ...
  3: [ // Age III Technologies (19 tiles) - Cost range: 4-6 Research (per Appendix C)
    // Propulsion (4 tiles)
