...
**Resolution:** Doubled the original implementation values to balance game length. Updated both spec and implementation to use consistent values:
...
**Files changed:**
- `server/config/constants.js` - Updated PROGRESS_THRESHOLDS
- `spec/upship_rules.md` - Updated Section 1.3 table
